    ...
    <section className="bg-paper-sage px-[clamp(1rem,3vw,3rem)] py-[clamp(5rem,10vw,10rem)]">
      <div className="mx-auto max-w-[1080px]">
        <blockquote className="m-0 border-l-[3px] border-accent-clay pl-[clamp(1.25rem,2.5vw,2.5rem)]">
          <p className="m-0 font-display text-[clamp(1.5rem,2.8vw,2.8rem)] font-normal leading-[1.2] tracking-[-0.025em] text-ink-900 before:content-['“'] before:text-accent-clay/60 after:content-['”'] after:text-accent-clay/60">
            {project.quote.text}
          </p>
          <footer className="mt-6 flex flex-col gap-1 font-mono text-xs uppercase tracking-[0.22em] text-ink-700">
